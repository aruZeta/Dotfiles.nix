...
#+begin_src lisp :tangle generated/sbcl-config.lisp
(let ((ql-init
...
SBCL_HOME = "${config.xdg.configHome}/sbcl";
#+end_src
...
#+begin_src nix
xdg.configFile = {
  "sbcl/sbclrc".source = ./sbcl-config.lisp;
  "sbcl/sbcl.core".source = "${pkgs.sbcl}/lib/sbcl/sbcl.core";
};
#+end_src
